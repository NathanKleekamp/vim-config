...
set runtimepath+=~/.vim/bundle/editorconfig
set runtimepath+=~/.vim/bundle/emmet-vim
set runtimepath+=~/.vim/bundle/eunuch
...
set runtimepath+=~/.vim/bundle/multiple-cursors
set runtimepath+=~/.vim/bundle/neoterm
set runtimepath+=~/.vim/bundle/repeat
set runtimepath+=~/.vim/bundle/trailing-whitespace
...
set runtimepath+=~/.vim/bundle/vim-js-file-import
set runtimepath+=~/.vim/bundle/vim-parinfer
set runtimepath+=~/.vim/bundle/vim-polyglot
set runtimepath+=~/.vim/bundle/vim-surround
set runtimepath+=~/.vim/bundle/vim-vue
set runtimepath+=~/.vim/bundle/visualstar
...
argglobal
%argdel
$argadd packages/web/src/components/errorBoundry.tsx
edit packages/web/types/logger.d.ts
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 85 + 213) / 426)
exe 'vert 2resize ' . ((&columns * 84 + 213) / 426)
exe 'vert 3resize ' . ((&columns * 84 + 213) / 426)
exe 'vert 4resize ' . ((&columns * 85 + 213) / 426)
exe 'vert 5resize ' . ((&columns * 84 + 213) / 426)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("packages/web/src/errors/index.tsx") | buffer packages/web/src/errors/index.tsx | else | edit packages/web/src/errors/index.tsx | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
wincmd w
argglobal
if bufexists("packages/web/src/common/logging.ts") | buffer packages/web/src/common/logging.ts | else | edit packages/web/src/common/logging.ts | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
wincmd w
argglobal
if bufexists("packages/web/src/components/toggle.tsx") | buffer packages/web/src/components/toggle.tsx | else | edit packages/web/src/components/toggle.tsx | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
wincmd w
argglobal
if bufexists("packages/web/src/components/errorBoundry.tsx") | buffer packages/web/src/components/errorBoundry.tsx | else | edit packages/web/src/components/errorBoundry.tsx | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
exe 'vert 5resize ' . ((&columns * 84 + 213) / 426)
tabnext 1
badd +0 packages/web/src/components/errorBoundry.tsx
badd +0 packages/web/src/components/toggle.tsx
badd +0 packages/web/src/common/logging.ts
badd +0 packages/web/src/errors/index.tsx
badd +0 packages/web/types/logger.d.ts
