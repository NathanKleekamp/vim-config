...
argglobal
%argdel
$argadd packages/app/job-store/sdk.ts
edit packages/app/job-store/tests/sdk.test.ts
...
wincmd w
argglobal
if bufexists("packages/app/job-store/types.d.ts") | buffer packages/app/job-store/types.d.ts | else | edit packages/app/job-store/types.d.ts | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
wincmd w
argglobal
if bufexists("packages/app/job-store/dynamo-adapter.ts") | buffer packages/app/job-store/dynamo-adapter.ts | else | edit packages/app/job-store/dynamo-adapter.ts | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
wincmd w
argglobal
if bufexists("packages/app/job-store/sdk.ts") | buffer packages/app/job-store/sdk.ts | else | edit packages/app/job-store/sdk.ts | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
exe 'vert 5resize ' . ((&columns * 84 + 213) / 426)
tabnext 1
badd +0 packages/app/job-store/sdk.ts
badd +1 packages/app/job-store/dynamo-adapter.ts
badd +4 packages/app/job-store/types.d.ts
badd +5 packages/app/job-store/tests/sdk.test.ts
