...
silent only
cd ~/Projects/bbp-forms
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/components/bbp-button/Button.vue
badd +0 src/components/bbp-input-text/InputText.vue
badd +0 src/components/bbp-select/Select.vue
badd +0 src/components/mixins/form-element/index.js
badd +0 \!bash\ --login
argglobal
silent! argdel *
$argadd src/components/bbp-button/Button.vue
$argadd src/components/bbp-input-text/InputText.vue
$argadd src/components/bbp-select/Select.vue
$argadd src/components/mixins/form-element/index.js
edit src/components/bbp-button/Button.vue
...
exe 'vert 1resize ' . ((&columns * 69 + 172) / 345)
exe 'vert 2resize ' . ((&columns * 68 + 172) / 345)
exe 'vert 3resize ' . ((&columns * 68 + 172) / 345)
exe 'vert 4resize ' . ((&columns * 68 + 172) / 345)
exe 'vert 5resize ' . ((&columns * 68 + 172) / 345)
argglobal
enew
file \!bash\ --login
setlocal keymap=
